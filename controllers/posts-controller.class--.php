	...
	public function execute()
	{
		...
		*/
		...
		if(is_numeric($this->page))
		{
			...
			$page_data = array(
				'page_title'       => sanitize_html_attribute( $post->get('title') ),
				'page_keywords'    => $keywords,
				'page_description' => sanitize_html_attribute( $post->get('content') ),
				'robots_value'     => 'all',
				'post_id'          => $post_id,
				'post'             => $post,
				'open_graph_data'  => array(
					'url'          => get_post_url($post_id),
					'title'        => sanitize_html_attribute( $post->get('title') ),
					'description'  => sanitize_html_attribute( $post->get('content') ),
