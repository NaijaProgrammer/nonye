...
if($_SERVER['REQUEST_METHOD'] == 'POST'):
	...
	update_app_settings( array(
		...
		'registration-success-message'     => htmlspecialchars( $registration_success_msg ),
		'registration-success-mail-sender' => 'admin@mysite.com',
		'password-recovery-mail'           => htmlspecialchars( $password_recovery_msg ),
		'password-recovery-mail-sender'    => 'password-recovery@mysite.com'
	) );
