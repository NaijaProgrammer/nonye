...
?>
<?php $curr_url = generate_url(array('controller'=>'posts', 'action'=>'new')); ?>
<?php //only authenticate user who tries to view as mentor ?>
<?php if( isset($_GET['mentor-view']) ): $page_instance->authenticate_user( array('redirect_url'=>$curr_url, 'current_url'=>$curr_url ) ); endif; ?>
<?php
...
$page_instance->add_stylesheets( array(/*$theme_url. '/css/heroic-features.css'*/) );
