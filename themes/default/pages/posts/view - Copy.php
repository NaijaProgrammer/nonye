   ...
   <ul class="topic-meta">
    <li class="text-center">
	 ...
	 <img id="topic-author-image" class="user-card-trigge" src="<?php echo get_user_image_url($post_author->get('id')); ?>" 
	  ...
	  data-last-seen="<?php echo sanitize_html_attribute($post_author->get('last-seen-time')); ?>"
	  data-join-date="<?php echo sanitize_html_attribute($post_author->get('date_registered')); ?>"
	 ...
	 <span class="topic-meta-value date-created" title="<?php echo sanitize_html_attribute($post_date_added); ?>"><?php echo $post_date_added; ?></span>
    </li>
	<li class="text-center">
   ...
   <div class="col-lg-10">
	<div class="post-content">
	 ...
	 <div class="share-icons">
	    <a class="share-icon" title="share on Facebook" onclick="shareOnFb('<?php echo $post_short_url; ?>');"><img src="<?php echo $icons_url; ?>/fb-icon-16.png" alt="share on facebook" /></a>
	    <a class="share-icon" title="share on Google+" onclick="shareOnGPlus('<?php echo urlencode($post_short_url); ?>')"><img src="<?php echo $icons_url; ?>/gplus-icon-16.png" alt="share on google-plus" /></a>
	    <a class="share-icon" title="share on LinkedIn" onclick="shareOnLinkedIn('<?php echo urlencode($post_short_url); ?>', '<?php echo urlencode($post_title); ?>', '<?php echo urlencode(get_substring($post_content)); ?>')"><img src="<?php echo $icons_url; ?>/linked-in-icon-16.png" alt="share on linked-in" /></a>
		<a class="share-icon" title="share on Twitter" href="https://twitter.com/intent/tweet?text=<?php echo urlencode($post_title); ?>&url=<?php echo urlencode($post_short_url); ?>"><img src="<?php echo $theme_url; ?>/images/social-icons/twitter-icon-16.png" alt="share on twitter" /></a>
	    <a class="share-icon" title="permalink to this post" onclick="slideToggle('post-permalink')"><i class="fa fa-link"></i></a>
	    <div id="post-permalink" class="post-permalink" style="display:none;"><?php echo $post_short_url; ?></div>
	 </div>
	 <a class="reply-link post-editor-opener cursor-pointer" data-parent-id="<?php echo $post->get('id'); ?>">Reply</a>
	</div> 
   </div>	
  </div>
 </article>
  ...
  <div class="row">
   ...
   <div class="col-lg-2 text-center">
    <a href="<?php echo sanitize_html_attribute(get_user_profile_url($comment_author->get('id'))); ?>">
	 <img class="post-author-image user-card-trigger" src="<?php echo sanitize_html_attribute( get_user_image_url($comment_author->get('id')) ); ?>" 
	  ...
	  data-last-seen="<?php echo sanitize_html_attribute($comment_author->get('last-seen-time')); ?>"
	  data-join-date="<?php echo sanitize_html_attribute($comment_author->get('date_registered')); ?>"
	  data-location="<?php echo sanitize_html_attribute($post_author->get('location')); ?>"
	 />
   ...
   <div class="col-lg-10">
	<div class="post-content">
	 ...
	 <div class="share-icons">
	    <a class="share-icon" title="share on Facebook" onclick="shareOnFb('<?php echo $comment_short_url; ?>');"><img src="<?php echo $theme_url; ?>/images/social-icons/fb-icon-16.png" alt="share on facebook" /></a>
	    <a class="share-icon" title="share on Google+" onclick="shareOnGPlus('<?php echo urlencode($comment_short_url); ?>')"><img src="<?php echo $theme_url; ?>/images/social-icons/gplus-icon-16.png" alt="share on google-plus" /></a>
	    <a class="share-icon" title="share on LinkedIn" onclick="shareOnLinkedIn('<?php echo urlencode($comment_short_url); ?>', '<?php echo urlencode('Response to '. $post_title); ?>', '<?php echo urlencode(get_substring($comment->get('content'))); ?>')"><img src="<?php echo $icons_url; ?>/linked-in-icon-16.png" alt="share on linked-in" /></a>	    
		<a class="share-icon" title="share on Twitter" href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Response to '. $post_title); ?>&url=<?php echo urlencode($comment_short_url); ?>"><img src="<?php echo $theme_url; ?>/images/social-icons/twitter-icon-16.png" alt="share on twitter" /></a>
	    <a class="share-icon" title="permalink to this post" onclick="slideToggle('response-<?php echo $comment_id; ?>-permalink')"><i class="fa fa-link"></i></a>
	    <div id="response-<?php echo $comment_id; ?>-permalink" class="post-permalink" style="display:none;"><?php echo $comment_short_url; ?></div>
	 </div>
	 <!--<a class="reply-link post-editor-opener cursor-pointer" data-parent-id="<?php //echo $comment->get('id'); ?>">Reply</a>-->
	</div> 
   </div>	
  </div>
 </article>
