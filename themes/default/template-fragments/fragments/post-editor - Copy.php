...
<form id="new-post-form">
 ...
 <div class="col-md-4" style="padding-left:0 !important;"><input id="post-title-field" class="form-control" type="text" placeholder="title"/></div>
 <div class="col-md-4">
...
$('#new-post-form').on('submit', function(e){
	...
	else
	{
		...
		extraData = {
			create   : true,
			title    : $('#post-title-field').val(),
			forum    : $('#post-forum-selector').val(),
			category : $('#post-category-selector').val(),
			tags     : JSON.stringify( postTagsField.tagEditor('getTags')[0].tags )
		}
	}
