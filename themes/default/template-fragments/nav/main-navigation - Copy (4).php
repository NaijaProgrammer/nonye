     ...
     <div class="input-group" id="adv-search">
      ...
      <div class="input-group-btn">
       <div class="btn-group" role="group">
        ...
        <button type="button" id="primary-post-search-btn" class="btn btn-primary pr25 post-search-btn"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
       </div>
      </div>
     </div>
	 
	 <div id="post-search-quick-results"></div>
	...
	function displaySuggestedPosts(posts)
	{
		...
		function assembleHTML(post)
		{
			...
			'<div style="background:#fff; padding:5px 8px; margin-bottom:2px;">',
				...
				'<span class="date" title="' + post.fDateCreated + '">Created: ' + post.dateCreated + ' ago</span><br>',
