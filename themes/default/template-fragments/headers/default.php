...
<html lang="en" prefix="og: http://ogp.me/ns#">
 <head>
	...
	<script src="<?php echo $theme_url; ?>/js/theme-functions.js"></script>
	...
	<!--<script src="<?php echo $site_url; ?>/chat/chat_loader.php"></script>-->
...
<script>initFBSDK();</script>

<?php else: ?>
<script src="<?php echo $site_url; ?>/js/lib/fb/fb-login/fb-login.js"></script>
<script>
initFBSDK(doFBLogin, {
	loginTrigger : 'fb-login-link',
	notLoggedIn  : function userNotLoggedInToFacebook(response){},
	notAuthorized : function userDidntAuthorizeOurApp(response){},
	success      : function authenticateUser(response){
