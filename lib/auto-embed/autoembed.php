 ...
 * @package AutoEmbed
 */
//source: https://www.warpconduit.net/2013/04/13/automatically-embedding-video-using-only-the-url-with-the-help-of-oembed/
class AutoEmbed {
	...
	{
		$attr['discover'] = true;
        $return = $this->get_data( $url, $attr) or $return = array($url);
		return $return;
	}
