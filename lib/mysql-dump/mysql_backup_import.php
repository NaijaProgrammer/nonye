...
# end values result
	...
	//file_put_contents($fullname, $return);
...
/**
* @downloaded from: https://gist.github.com/aufa/10584239 Sept 29, 2015
* Changes by Michael Orji:
* Removed the 'gzip'-ing since it was making it impossible to uncompress the file
* - Made the file downloadable by default, even when it has been saved to destination
*/