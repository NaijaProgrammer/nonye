...
{ 
	...
	{
		$array_data = array( 'error'=>true, 'message'=>'Please login as Super Admin to add another Super Admin');
	}
	else
	{
 ...
 <div class="middle">
  <div class="inner">
   <center>
	...
	<p>Sorry, this page is for creating the Super Admin upon installation!</p>
	<p>To create a new user, Please sign in as the super admin.</p>
