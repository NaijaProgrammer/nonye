 ...
 */
 maxZIndex: 11, 
   ...
   */
   ...
   {
    var win = detectObjectness(winId);
       if(win){
        win.isActive = true;
   ...
   */
   ...
   {
      var winObj = this.getWindowAsObject(win);
       
       if(winObj.element.parentNode){
   ...
   Position: {
      ...
      getScrollPosition: function (){
       ...
       return Scroll;
      } //end getScrollPosition, this is complete
   }//end Position
}