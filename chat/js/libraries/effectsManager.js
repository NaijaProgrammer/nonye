 ...
 var prevMouseY;
   ...
   if(document.actionType == 'move'){
    ...
    maintainBoundary(target);  
       if(typeof target.element != 'undefined'){ //this is because of dynamic created using FloatingWindow constructor
        target.element.moved = true; 
       }
       else{ target.moved = true;}
...
Effects.fadeIn = function (elemId, maxOpacity, speed) 
{
 ...
 speed = speed || 10000;
   ...
   {
    setTimeout( "StyleManager.setElementOpacity('" + elemId + "'," + opacityLevel + ")",  (opacityLevel * speed));
    opacityLevel += 0.01;
   }
}
...
Effects.fadeOut = function (elemId, minOpacity, speed){
 ...
 speed = speed || 10000;
   ...
   {     
    setTimeout( "StyleManager.setElementOpacity('" + elemId + "'," + opacityLevel + ")", (timer * speed));
